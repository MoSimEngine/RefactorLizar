...
public class RefactorLizar {
  ...
  @Nonnull public static RefactorLizar load(InputSourceSimulator inputSourceSimulator,
    ...
    ModularLanguage modularLanguage = new ModularLanguage(new LanguageParser()
        .parseLanguage(inputSourceModularLanguage.getParameters().get(fileSystemName())));

    SimulatorModel simulatorModel = new SimulatorModel(new SimulatorParser()
        .parseLanguage(inputSourceSimulator.getParameters().get(fileSystemName())));
