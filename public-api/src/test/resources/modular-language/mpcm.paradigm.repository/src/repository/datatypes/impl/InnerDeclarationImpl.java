 ...
 * </p>
 * <ul>
 *   <li>{@link repository.datatypes.impl.InnerDeclarationImpl#getDatatype_InnerDeclaration <em>Datatype Inner Declaration</em>}</li>
 *   <li>{@link repository.datatypes.impl.InnerDeclarationImpl#getCompositeDataType_InnerDeclaration <em>Composite Data Type Inner Declaration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InnerDeclarationImpl extends NamedElementImpl implements InnerDeclaration {
	...
	protected EClass eStaticClass() {
		return DatatypesPackage.Literals.INNER_DECLARATION;
	}
		...
		if (datatype_InnerDeclaration != null && datatype_InnerDeclaration.eIsProxy()) {
			...
			if (datatype_InnerDeclaration != oldDatatype_InnerDeclaration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatatypesPackage.INNER_DECLARATION__DATATYPE_INNER_DECLARATION, oldDatatype_InnerDeclaration, datatype_InnerDeclaration));
			}
		}
	...
	public void setDatatype_InnerDeclaration(DataType newDatatype_InnerDeclaration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.INNER_DECLARATION__DATATYPE_INNER_DECLARATION, oldDatatype_InnerDeclaration, datatype_InnerDeclaration));
	}
	...
	public CompositeDataType getCompositeDataType_InnerDeclaration() {
		if (eContainerFeatureID() != DatatypesPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION) return null;
	...
	public NotificationChain basicSetCompositeDataType_InnerDeclaration(CompositeDataType newCompositeDataType_InnerDeclaration, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCompositeDataType_InnerDeclaration, DatatypesPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION, msgs);
		return msgs;
	}
	...
	public void setCompositeDataType_InnerDeclaration(CompositeDataType newCompositeDataType_InnerDeclaration) {
		if (newCompositeDataType_InnerDeclaration != eInternalContainer() || (eContainerFeatureID() != DatatypesPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION && newCompositeDataType_InnerDeclaration != null)) {
			...
			if (newCompositeDataType_InnerDeclaration != null)
				msgs = ((InternalEObject)newCompositeDataType_InnerDeclaration).eInverseAdd(this, DatatypesPackage.COMPOSITE_DATA_TYPE__INNER_DECLARATION_COMPOSITE_DATA_TYPE, CompositeDataType.class, msgs);
			msgs = basicSetCompositeDataType_InnerDeclaration(newCompositeDataType_InnerDeclaration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION, newCompositeDataType_InnerDeclaration, newCompositeDataType_InnerDeclaration));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DatatypesPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DatatypesPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION:
				return eInternalContainer().eInverseRemove(this, DatatypesPackage.COMPOSITE_DATA_TYPE__INNER_DECLARATION_COMPOSITE_DATA_TYPE, CompositeDataType.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatatypesPackage.INNER_DECLARATION__DATATYPE_INNER_DECLARATION:
