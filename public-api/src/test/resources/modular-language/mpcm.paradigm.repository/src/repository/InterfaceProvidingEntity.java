 ...
 * </p>
 * <ul>
 *   <li>{@link repository.InterfaceProvidingEntity#getProvidedRoles_InterfaceProvidingEntity <em>Provided Roles Interface Providing Entity</em>}</li>
 * </ul>
 *
 * @see repository.RepositoryPackage#getInterfaceProvidingEntity()
 * @model abstract="true"
 * @generated
 */
public interface InterfaceProvidingEntity extends Entity {
	 ...
	 * The list contents are of type {@link repository.ProvidedRole}.
	 * It is bidirectional and its opposite is '{@link repository.ProvidedRole#getProvidingEntity_ProvidedRole <em>Providing Entity Provided Role</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Provided Roles Interface Providing Entity</em>' containment reference list.
	 * @see repository.RepositoryPackage#getInterfaceProvidingEntity_ProvidedRoles_InterfaceProvidingEntity()
