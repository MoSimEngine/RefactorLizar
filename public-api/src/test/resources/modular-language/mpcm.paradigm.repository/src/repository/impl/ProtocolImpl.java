 ...
 * </p>
 * <ul>
 *   <li>{@link repository.impl.ProtocolImpl#getProtocolTypeID <em>Protocol Type ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ProtocolImpl extends MinimalEObjectImpl.Container implements Protocol {
	...
	protected EClass eStaticClass() {
		return RepositoryPackage.Literals.PROTOCOL;
	}
	...
	public void setProtocolTypeID(String newProtocolTypeID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.PROTOCOL__PROTOCOL_TYPE_ID, oldProtocolTypeID, protocolTypeID));
	}
