 ...
 * </p>
 * <ul>
 *   <li>{@link softwareusage.impl.UserDataImpl#getAssemblyContext_userData <em>Assembly Context user Data</em>}</li>
 *   <li>{@link softwareusage.impl.UserDataImpl#getUsageModel_UserData <em>Usage Model User Data</em>}</li>
 *   <li>{@link softwareusage.impl.UserDataImpl#getUserDataParameterUsages_UserData <em>User Data Parameter Usages User Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserDataImpl extends MinimalEObjectImpl.Container implements UserData {
	...
	protected EClass eStaticClass() {
		return SoftwareusagePackage.Literals.USER_DATA;
	}
		...
		if (assemblyContext_userData != null && assemblyContext_userData.eIsProxy()) {
			...
			if (assemblyContext_userData != oldAssemblyContext_userData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SoftwareusagePackage.USER_DATA__ASSEMBLY_CONTEXT_USER_DATA, oldAssemblyContext_userData, assemblyContext_userData));
			}
		}
	...
	public void setAssemblyContext_userData(AssemblyContext newAssemblyContext_userData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareusagePackage.USER_DATA__ASSEMBLY_CONTEXT_USER_DATA, oldAssemblyContext_userData, assemblyContext_userData));
	}
	...
	public UsageModel getUsageModel_UserData() {
		if (eContainerFeatureID() != SoftwareusagePackage.USER_DATA__USAGE_MODEL_USER_DATA) return null;
	...
	public NotificationChain basicSetUsageModel_UserData(UsageModel newUsageModel_UserData, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newUsageModel_UserData, SoftwareusagePackage.USER_DATA__USAGE_MODEL_USER_DATA, msgs);
		return msgs;
	}
	...
	public void setUsageModel_UserData(UsageModel newUsageModel_UserData) {
		if (newUsageModel_UserData != eInternalContainer() || (eContainerFeatureID() != SoftwareusagePackage.USER_DATA__USAGE_MODEL_USER_DATA && newUsageModel_UserData != null)) {
			...
			if (newUsageModel_UserData != null)
				msgs = ((InternalEObject)newUsageModel_UserData).eInverseAdd(this, SoftwareusagePackage.USAGE_MODEL__USER_DATA_USAGE_MODEL, UsageModel.class, msgs);
			msgs = basicSetUsageModel_UserData(newUsageModel_UserData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwareusagePackage.USER_DATA__USAGE_MODEL_USER_DATA, newUsageModel_UserData, newUsageModel_UserData));
	}
	...
	public EList<VariableUsage> getUserDataParameterUsages_UserData() {
		if (userDataParameterUsages_UserData == null) {
			userDataParameterUsages_UserData = new EObjectContainmentEList<VariableUsage>(VariableUsage.class, this, SoftwareusagePackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SoftwareusagePackage.USER_DATA__USAGE_MODEL_USER_DATA:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SoftwareusagePackage.USER_DATA__USAGE_MODEL_USER_DATA:
				return eInternalContainer().eInverseRemove(this, SoftwareusagePackage.USAGE_MODEL__USER_DATA_USAGE_MODEL, UsageModel.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SoftwareusagePackage.USER_DATA__ASSEMBLY_CONTEXT_USER_DATA:
