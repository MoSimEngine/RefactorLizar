...
public class AnnotationsAdapterFactory extends AdapterFactoryImpl {
	...
	protected AnnotationsSwitch<Adapter> modelSwitch =
		new AnnotationsSwitch<Adapter>() {
			@Override
			public Adapter caseAnnotationRoot(AnnotationRoot object) {
				return createAnnotationRootAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseServiceOutputParameterAbstraction(ServiceOutputParameterAbstraction object) {
				return createServiceOutputParameterAbstractionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link annotations.AnnotationRoot <em>Annotation Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link annotations.ServiceOutputParameterAbstraction <em>Service Output Parameter Abstraction</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createServiceOutputParameterAbstractionAdapter() {
		return null;
	}
