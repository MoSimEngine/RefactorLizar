...
public class ResourcetypeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResourcetypePackage.RESOURCE_INTERFACE_RESOURCETYPE_ROOT: {
				ResourceInterfaceResourcetypeRoot resourceInterfaceResourcetypeRoot = (ResourceInterfaceResourcetypeRoot)theEObject;
				T result = caseResourceInterfaceResourcetypeRoot(resourceInterfaceResourcetypeRoot);
			...
			case ResourcetypePackage.RESOURCE_INTERFACE_PROVIDING_ENTITY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resource Interface Resourcetype Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resource Interface Resourcetype Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResourceInterfaceResourcetypeRoot(ResourceInterfaceResourcetypeRoot object) {
		return null;
	}
