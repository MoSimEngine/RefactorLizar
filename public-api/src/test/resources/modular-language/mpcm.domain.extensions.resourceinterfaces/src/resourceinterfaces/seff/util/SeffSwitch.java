...
public class SeffSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SeffPackage.RESOURCE_INTERFACES_SEFF_ROOT: {
				ResourceInterfacesSEFFRoot resourceInterfacesSEFFRoot = (ResourceInterfacesSEFFRoot)theEObject;
				T result = caseResourceInterfacesSEFFRoot(resourceInterfacesSEFFRoot);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resource Interfaces SEFF Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resource Interfaces SEFF Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResourceInterfacesSEFFRoot(ResourceInterfacesSEFFRoot object) {
		return null;
	}
