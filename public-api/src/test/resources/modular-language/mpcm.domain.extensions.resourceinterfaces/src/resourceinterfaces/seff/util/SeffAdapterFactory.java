...
public class SeffAdapterFactory extends AdapterFactoryImpl {
	...
	protected SeffSwitch<Adapter> modelSwitch =
		new SeffSwitch<Adapter>() {
			@Override
			public Adapter caseResourceInterfacesSEFFRoot(ResourceInterfacesSEFFRoot object) {
				return createResourceInterfacesSEFFRootAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link resourceinterfaces.seff.ResourceInterfacesSEFFRoot <em>Resource Interfaces SEFF Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link resourceinterfaces.seff.ResourceCall <em>Resource Call</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
