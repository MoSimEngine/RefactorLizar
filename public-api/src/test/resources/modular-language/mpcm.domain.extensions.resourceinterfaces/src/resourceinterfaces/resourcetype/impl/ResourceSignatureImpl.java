 ...
 * </p>
 * <ul>
 *   <li>{@link resourceinterfaces.resourcetype.impl.ResourceSignatureImpl#getParameter__ResourceSignature <em>Parameter Resource Signature</em>}</li>
 *   <li>{@link resourceinterfaces.resourcetype.impl.ResourceSignatureImpl#getResourceServiceId <em>Resource Service Id</em>}</li>
 *   <li>{@link resourceinterfaces.resourcetype.impl.ResourceSignatureImpl#getResourceInterface__ResourceSignature <em>Resource Interface Resource Signature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceSignatureImpl extends EntityImpl implements ResourceSignature {
	...
	public EList<Parameter> getParameter__ResourceSignature() {
		if (parameter__ResourceSignature == null) {
			parameter__ResourceSignature = new EObjectContainmentEList<Parameter>(Parameter.class, this, ResourcetypePackage.RESOURCE_SIGNATURE__PARAMETER_RESOURCE_SIGNATURE);
		}
