...
public class SeffSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SeffPackage.PERFORMANCE_SEFF_ROOT: {
				PerformanceSEFFRoot performanceSEFFRoot = (PerformanceSEFFRoot)theEObject;
				T result = casePerformanceSEFFRoot(performanceSEFFRoot);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Performance SEFF Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Performance SEFF Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePerformanceSEFFRoot(PerformanceSEFFRoot object) {
		return null;
	}
