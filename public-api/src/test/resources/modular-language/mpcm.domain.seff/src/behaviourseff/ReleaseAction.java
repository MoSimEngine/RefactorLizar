 ...
 * </p>
 * <ul>
 *   <li>{@link behaviourseff.ReleaseAction#getPassiveResource_ReleaseAction <em>Passive Resource Release Action</em>}</li>
 * </ul>
 *
 * @see behaviourseff.BehaviourseffPackage#getReleaseAction()
 * @model
 * @generated
 */
public interface ReleaseAction extends AbstractInternalControlFlowAction {
	 ...
	 * @see behaviourseff.BehaviourseffPackage#getReleaseAction_PassiveResource_ReleaseAction()
	...
	/**
	 * Sets the value of the '{@link behaviourseff.ReleaseAction#getPassiveResource_ReleaseAction <em>Passive Resource Release Action</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
