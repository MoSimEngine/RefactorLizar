 ...
 * </p>
 * <ul>
 *   <li>{@link behaviourseff.SetVariableAction#getLocalVariableUsages_SetVariableAction <em>Local Variable Usages Set Variable Action</em>}</li>
 * </ul>
 *
 * @see behaviourseff.BehaviourseffPackage#getSetVariableAction()
 * @model
 * @generated
 */
public interface SetVariableAction extends AbstractInternalControlFlowAction {
	 ...
	 * @see behaviourseff.BehaviourseffPackage#getSetVariableAction_LocalVariableUsages_SetVariableAction()
