 ...
 * </p>
 * <ul>
 *   <li>{@link events.composition.impl.AssemblyEventConnectorImpl#getSinkRole__AssemblyEventConnector <em>Sink Role Assembly Event Connector</em>}</li>
 *   <li>{@link events.composition.impl.AssemblyEventConnectorImpl#getSourceRole__AssemblyEventConnector <em>Source Role Assembly Event Connector</em>}</li>
 *   <li>{@link events.composition.impl.AssemblyEventConnectorImpl#getSinkAssemblyContext__AssemblyEventConnector <em>Sink Assembly Context Assembly Event Connector</em>}</li>
 *   <li>{@link events.composition.impl.AssemblyEventConnectorImpl#getSourceAssemblyContext__AssemblyEventConnector <em>Source Assembly Context Assembly Event Connector</em>}</li>
 *   <li>{@link events.composition.impl.AssemblyEventConnectorImpl#getFilterCondition__AssemblyEventConnector <em>Filter Condition Assembly Event Connector</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public void setFilterCondition__AssemblyEventConnector(PCMRandomVariable newFilterCondition__AssemblyEventConnector) {
		if (newFilterCondition__AssemblyEventConnector != filterCondition__AssemblyEventConnector) {
			...
			if (newFilterCondition__AssemblyEventConnector != null)
				msgs = ((InternalEObject)newFilterCondition__AssemblyEventConnector).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CompositionPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR, null, msgs);
