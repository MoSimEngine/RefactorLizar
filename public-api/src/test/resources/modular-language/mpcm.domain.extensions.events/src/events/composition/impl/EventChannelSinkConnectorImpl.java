 ...
 * </p>
 * <ul>
 *   <li>{@link events.composition.impl.EventChannelSinkConnectorImpl#getSinkRole__EventChannelSinkConnector <em>Sink Role Event Channel Sink Connector</em>}</li>
 *   <li>{@link events.composition.impl.EventChannelSinkConnectorImpl#getFilterCondition__EventChannelSinkConnector <em>Filter Condition Event Channel Sink Connector</em>}</li>
 *   <li>{@link events.composition.impl.EventChannelSinkConnectorImpl#getAssemblyContext__EventChannelSinkConnector <em>Assembly Context Event Channel Sink Connector</em>}</li>
 *   <li>{@link events.composition.impl.EventChannelSinkConnectorImpl#getEventChannel__EventChannelSinkConnector <em>Event Channel Event Channel Sink Connector</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public void setFilterCondition__EventChannelSinkConnector(PCMRandomVariable newFilterCondition__EventChannelSinkConnector) {
		if (newFilterCondition__EventChannelSinkConnector != filterCondition__EventChannelSinkConnector) {
			...
			if (newFilterCondition__EventChannelSinkConnector != null)
				msgs = ((InternalEObject)newFilterCondition__EventChannelSinkConnector).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CompositionPackage.EVENT_CHANNEL_SINK_CONNECTOR__FILTER_CONDITION_EVENT_CHANNEL_SINK_CONNECTOR, null, msgs);
