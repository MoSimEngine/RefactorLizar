 ...
 * </p>
 * <ul>
 *   <li>{@link usage.impl.LoopImpl#getLoopIteration_Loop <em>Loop Iteration Loop</em>}</li>
 *   <li>{@link usage.impl.LoopImpl#getBodyBehaviour_Loop <em>Body Behaviour Loop</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoopImpl extends AbstractUserActionImpl implements Loop {
	...
	protected EClass eStaticClass() {
		return UsagePackage.Literals.LOOP;
	}
	...
	public NotificationChain basicSetLoopIteration_Loop(PCMRandomVariable newLoopIteration_Loop, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsagePackage.LOOP__LOOP_ITERATION_LOOP, oldLoopIteration_Loop, newLoopIteration_Loop);
	...
	public void setLoopIteration_Loop(PCMRandomVariable newLoopIteration_Loop) {
		if (newLoopIteration_Loop != loopIteration_Loop) {
			...
			if (loopIteration_Loop != null)
				msgs = ((InternalEObject)loopIteration_Loop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsagePackage.LOOP__LOOP_ITERATION_LOOP, null, msgs);
			if (newLoopIteration_Loop != null)
				msgs = ((InternalEObject)newLoopIteration_Loop).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsagePackage.LOOP__LOOP_ITERATION_LOOP, null, msgs);
			msgs = basicSetLoopIteration_Loop(newLoopIteration_Loop, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsagePackage.LOOP__LOOP_ITERATION_LOOP, newLoopIteration_Loop, newLoopIteration_Loop));
	}
	...
	public NotificationChain basicSetBodyBehaviour_Loop(ScenarioBehaviour newBodyBehaviour_Loop, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsagePackage.LOOP__BODY_BEHAVIOUR_LOOP, oldBodyBehaviour_Loop, newBodyBehaviour_Loop);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBodyBehaviour_Loop(ScenarioBehaviour newBodyBehaviour_Loop) {
		if (newBodyBehaviour_Loop != bodyBehaviour_Loop) {
			...
			if (bodyBehaviour_Loop != null)
				msgs = ((InternalEObject)bodyBehaviour_Loop).eInverseRemove(this, UsagePackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR, ScenarioBehaviour.class, msgs);
			if (newBodyBehaviour_Loop != null)
				msgs = ((InternalEObject)newBodyBehaviour_Loop).eInverseAdd(this, UsagePackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR, ScenarioBehaviour.class, msgs);
			msgs = basicSetBodyBehaviour_Loop(newBodyBehaviour_Loop, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsagePackage.LOOP__BODY_BEHAVIOUR_LOOP, newBodyBehaviour_Loop, newBodyBehaviour_Loop));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UsagePackage.LOOP__BODY_BEHAVIOUR_LOOP:
				if (bodyBehaviour_Loop != null)
					msgs = ((InternalEObject)bodyBehaviour_Loop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsagePackage.LOOP__BODY_BEHAVIOUR_LOOP, null, msgs);
