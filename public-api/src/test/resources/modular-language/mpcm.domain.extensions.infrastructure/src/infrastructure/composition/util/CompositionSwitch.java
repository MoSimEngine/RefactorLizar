/**
 */
package infrastructure.composition.util;
 ...
 * <!-- end-user-doc -->
 * @see infrastructure.composition.CompositionPackage
 * @generated
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CompositionPackage.ASSEMBLY_INFRASTRUCTURE_CONNECTOR: {
				...
				if (result == null) result = caseContainable(assemblyInfrastructureConnector);
			...
			case CompositionPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR: {
				...
				if (result == null) result = caseContainable(providedInfrastructureDelegationConnector);
			...
			case CompositionPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR: {
				...
				if (result == null) result = caseContainable(requiredInfrastructureDelegationConnector);
