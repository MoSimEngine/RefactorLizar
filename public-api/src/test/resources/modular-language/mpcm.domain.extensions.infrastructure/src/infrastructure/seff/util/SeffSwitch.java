...
public class SeffSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SeffPackage.INFRASTRUCTURE_SEFF_ROOT: {
				InfrastructureSEFFRoot infrastructureSEFFRoot = (InfrastructureSEFFRoot)theEObject;
				T result = caseInfrastructureSEFFRoot(infrastructureSEFFRoot);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Infrastructure SEFF Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Infrastructure SEFF Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInfrastructureSEFFRoot(InfrastructureSEFFRoot object) {
		return null;
	}
