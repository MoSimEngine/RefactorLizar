...
public class SeffAdapterFactory extends AdapterFactoryImpl {
	...
	protected SeffSwitch<Adapter> modelSwitch =
		new SeffSwitch<Adapter>() {
			@Override
			public Adapter caseInfrastructureSEFFRoot(InfrastructureSEFFRoot object) {
				return createInfrastructureSEFFRootAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link infrastructure.seff.InfrastructureSEFFRoot <em>Infrastructure SEFF Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link infrastructure.seff.InfrastructureCall <em>Infrastructure Call</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
