...
public class RepositorySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RepositoryPackage.INFRASTRUCTURE_REPOSITORY_ROOT: {
				InfrastructureRepositoryRoot infrastructureRepositoryRoot = (InfrastructureRepositoryRoot)theEObject;
				T result = caseInfrastructureRepositoryRoot(infrastructureRepositoryRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RepositoryPackage.INFRASTRUCTURE_COMPONENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Infrastructure Repository Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Infrastructure Repository Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInfrastructureRepositoryRoot(InfrastructureRepositoryRoot object) {
		return null;
	}
