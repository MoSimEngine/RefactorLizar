 ...
 * @generated
 */
public class ReliabilityannotationsAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static ReliabilityannotationsPackage modelPackage;
	 ...
	 * @generated
	 */
	public ReliabilityannotationsAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = ReliabilityannotationsPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected ReliabilityannotationsSwitch<Adapter> modelSwitch =
		new ReliabilityannotationsSwitch<Adapter>() {
			@Override
			public Adapter caseServiceReliabilityAnnotation(ServiceReliabilityAnnotation object) {
				return createServiceReliabilityAnnotationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link reliabilityannotations.ServiceReliabilityAnnotation <em>Service Reliability Annotation</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link reliabilityannotations.ExternalFailureOccurrenceDescription <em>External Failure Occurrence Description</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //ReliabilityannotationsAdapterFactory
