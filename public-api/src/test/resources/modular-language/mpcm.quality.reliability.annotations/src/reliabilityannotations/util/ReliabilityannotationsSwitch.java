 ...
 * @generated
 */
public class ReliabilityannotationsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ReliabilityannotationsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ReliabilityannotationsPackage.SERVICE_RELIABILITY_ANNOTATION: {
				ServiceReliabilityAnnotation serviceReliabilityAnnotation = (ServiceReliabilityAnnotation)theEObject;
				T result = caseServiceReliabilityAnnotation(serviceReliabilityAnnotation);
				if (result == null) result = caseServicePropertyAnnotation(serviceReliabilityAnnotation);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Reliability Annotation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Reliability Annotation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceReliabilityAnnotation(ServiceReliabilityAnnotation object) {
		return null;
	}
