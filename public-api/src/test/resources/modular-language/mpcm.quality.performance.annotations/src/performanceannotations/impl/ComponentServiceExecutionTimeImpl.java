...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Service Execution Time</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link performanceannotations.impl.ComponentServiceExecutionTimeImpl#getAssemblyContext_ComponentSpecifiedExecutionTime <em>Assembly Context Component Specified Execution Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentServiceExecutionTimeImpl extends ServiceExecutionTimeImpl implements ComponentServiceExecutionTime {
	/**
	 ...
	 * @generated
	 */
	protected ComponentServiceExecutionTimeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PerformanceannotationsPackage.Literals.COMPONENT_SERVICE_EXECUTION_TIME;
	}
		...
		if (assemblyContext_ComponentSpecifiedExecutionTime != null && assemblyContext_ComponentSpecifiedExecutionTime.eIsProxy()) {
			...
			if (assemblyContext_ComponentSpecifiedExecutionTime != oldAssemblyContext_ComponentSpecifiedExecutionTime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PerformanceannotationsPackage.COMPONENT_SERVICE_EXECUTION_TIME__ASSEMBLY_CONTEXT_COMPONENT_SPECIFIED_EXECUTION_TIME, oldAssemblyContext_ComponentSpecifiedExecutionTime, assemblyContext_ComponentSpecifiedExecutionTime));
			}
		}
	...
	public void setAssemblyContext_ComponentSpecifiedExecutionTime(AssemblyContext newAssemblyContext_ComponentSpecifiedExecutionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PerformanceannotationsPackage.COMPONENT_SERVICE_EXECUTION_TIME__ASSEMBLY_CONTEXT_COMPONENT_SPECIFIED_EXECUTION_TIME, oldAssemblyContext_ComponentSpecifiedExecutionTime, assemblyContext_ComponentSpecifiedExecutionTime));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PerformanceannotationsPackage.COMPONENT_SERVICE_EXECUTION_TIME__ASSEMBLY_CONTEXT_COMPONENT_SPECIFIED_EXECUTION_TIME:
...
} //ComponentServiceExecutionTimeImpl
