 ...
 * </p>
 * <ul>
 *   <li>{@link seff.impl.AbstractBranchTransitionImpl#getBranchAction_AbstractBranchTransition <em>Branch Action Abstract Branch Transition</em>}</li>
 *   <li>{@link seff.impl.AbstractBranchTransitionImpl#getBranchBehaviour_BranchTransition <em>Branch Behaviour Branch Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractBranchTransitionImpl extends EntityImpl implements AbstractBranchTransition {
	 ...
	 * @ordered
	 */
	protected Behaviour branchBehaviour_BranchTransition;
	 ...
	 */
	@Override
	public Behaviour getBranchBehaviour_BranchTransition() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBranchBehaviour_BranchTransition(Behaviour newBranchBehaviour_BranchTransition, NotificationChain msgs) {
		Behaviour oldBranchBehaviour_BranchTransition = branchBehaviour_BranchTransition;
	 ...
	 */
	@Override
	public void setBranchBehaviour_BranchTransition(Behaviour newBranchBehaviour_BranchTransition) {
		if (newBranchBehaviour_BranchTransition != branchBehaviour_BranchTransition) {
			NotificationChain msgs = null;
			if (branchBehaviour_BranchTransition != null)
				msgs = ((InternalEObject)branchBehaviour_BranchTransition).eInverseRemove(this, SeffPackage.BEHAVIOUR__ABSTRACT_BRANCH_TRANSITION_RESOURCE_DEMANDING_BEHAVIOUR, Behaviour.class, msgs);
			if (newBranchBehaviour_BranchTransition != null)
				msgs = ((InternalEObject)newBranchBehaviour_BranchTransition).eInverseAdd(this, SeffPackage.BEHAVIOUR__ABSTRACT_BRANCH_TRANSITION_RESOURCE_DEMANDING_BEHAVIOUR, Behaviour.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_BEHAVIOUR_BRANCH_TRANSITION:
				...
				return basicSetBranchBehaviour_BranchTransition((Behaviour)otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION:
				...
				return;
			case SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_BEHAVIOUR_BRANCH_TRANSITION:
				setBranchBehaviour_BranchTransition((Behaviour)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION:
				...
				return;
			case SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_BEHAVIOUR_BRANCH_TRANSITION:
				setBranchBehaviour_BranchTransition((Behaviour)null);
				return;
		}
