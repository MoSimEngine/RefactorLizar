 ...
 * </p>
 * <ul>
 *   <li>{@link seff.BranchAction#getBranches_Branch <em>Branches Branch</em>}</li>
 * </ul>
 *
 * @see seff.SeffPackage#getBranchAction()
 * @model
 * @generated
 */
public interface BranchAction extends AbstractInternalControlFlowAction {
	 ...
	 * The list contents are of type {@link seff.AbstractBranchTransition}.
	 * It is bidirectional and its opposite is '{@link seff.AbstractBranchTransition#getBranchAction_AbstractBranchTransition <em>Branch Action Abstract Branch Transition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Branches Branch</em>' containment reference list.
	 * @see seff.SeffPackage#getBranchAction_Branches_Branch()
