 ...
 *
 *
 * @see composition.CompositionPackage#getComposedProvidingRequiringEntity()
 * @model abstract="true"
 * @generated
 */
public interface ComposedProvidingRequiringEntity extends ComposedStructure, InterfaceProvidingRequiringEntity {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.providedRoles_InterfaceProvidingEntity-&gt;forAll(role|self.connectors__ComposedStructure-&gt;select(conn | conn.oclIsTypeOf(mpcm::core::composition::ProvidedDelegationConnector)).oclAsType(mpcm::core::composition::ProvidedDelegationConnector)-&gt;exists(connector|connector.outerProvidedRole_ProvidedDelegationConnector = role))\r\n\r\n'"
	 * @generated
	 */
