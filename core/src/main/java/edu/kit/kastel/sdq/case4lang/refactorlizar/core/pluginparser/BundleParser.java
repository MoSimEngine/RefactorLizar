...
public class BundleParser {
  ...
  /**
   * Analyses the given input paths. The method searches recursive for manifest files, so the input paths can point to upper folders.
  ...
  public Collection<Bundle> analyzeManifests(String... paths) {
    ...
    Collection<Bundle> bundles = manifestFiles.stream()
