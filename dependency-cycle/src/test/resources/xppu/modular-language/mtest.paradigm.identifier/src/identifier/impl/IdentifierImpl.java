 ...
 * </p>
 * <ul>
 *   <li>{@link identifier.impl.IdentifierImpl#getUUID <em>UUID</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifierImpl extends MinimalEObjectImpl.Container implements Identifier {
	...
	public void setUUID(String newUUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdentifierPackage.IDENTIFIER__UUID, oldUUID, uuid));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IdentifierPackage.IDENTIFIER__UUID:
				return getUUID();
		}
